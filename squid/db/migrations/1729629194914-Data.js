module.exports = class Data1729629194914 {
    name = 'Data1729629194914'

    async up(db) {
        await db.query(`CREATE TABLE "currency" ("id" character varying NOT NULL, "name" text, "symbol" text, "decimals" integer NOT NULL, "wrapping" boolean NOT NULL, "token_ids" text, "collection_id" character varying, CONSTRAINT "PK_3cda65c731a6264f0e444cc9b91" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE INDEX "IDX_a78fcddd9427ac82c45357c587" ON "pair_day" ("day") `)
        ...
        await db.query(`CREATE INDEX "IDX_0a8e9aeb3123430d0ddd557987" ON "pair_month" ("month") `)
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_a78fcddd9427ac82c45357c587"`)
        await db.query(`DROP TABLE "pair_month"`)
        await db.query(`DROP INDEX "public"."IDX_435e8ad87b8ba75c0b8e3b6d5c"`)
        await db.query(`DROP INDEX "public"."IDX_0a8e9aeb3123430d0ddd557987"`)
