...
contract ApeGenesis is ERC721AQueryable, ERC721ABurnable, Ownable {
    constructor() ERC721A("Ape Genesis", "APG") {}

    uint public publicSalesTimestamp = 1731825612;
    uint public endSalesTimestamp = 1734417612;
    uint public mintPrice = 10 ether; //INITIAL PRICE - APE COIN
